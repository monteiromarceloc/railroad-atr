...
DWORD WINAPI DepositaMensagens2();							// Thread representando a TAREFA DE RETIRADA DE ORDENS DE PRODUÇÃO
DWORD WINAPI DepositaMensagens1();							// Thread representando a TAREFA DE RETIRADA DE ORDENS DE PRODUÇÃO
