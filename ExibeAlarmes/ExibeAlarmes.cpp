...
//Impress�o do cabe�alho de paginas
void cabecalho() {
...
HANDLE hsEvent = OpenEvent(EVENT_ALL_ACCESS, FALSE, "ExibicaoAlarmesON-OFF");
...
int main()
{
	...
	HANDLE hEventDados;			//Handle para evento de sinaliza��o de MailSlot
	...
	do {
		...
		if (MsgCont == 0) {}
			...
			cout << "  NSEQ: ";
			for (int i = 0; i < 8; i++) { cout << MsgBuffer[i]; }
			cout << " DETECTOR: ";
